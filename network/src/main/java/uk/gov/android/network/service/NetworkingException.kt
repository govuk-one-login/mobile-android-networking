 ...
 */
abstract class NetworkingException(override val message: String, cause: Throwable? = null) :
    Exception(message, cause)

/**
 * The service that received the request wasn't configured correctly
 */
class ConfigurationException(message: String) : NetworkingException(message)
 ...
 * @see [DPoPException]
 */
open class ServiceException(message: String, cause: Throwable?) :
 ...
 */
class AuthenticationProviderException(message: String, cause: Throwable?) :
 ...
 * @see [DPoPProvider]
 */
class DPoPException(message: String, cause: Throwable?) : ServiceException(message, cause)

/**
 * The request wasn't configured properly
 */
class ApiRequestException(message: String, cause: Throwable?) : NetworkingException(message, cause)
 ...
 */
class TransportException(cause: Throwable?) :
