...
class KtorHttpClientTlsTest {
    ...
    @Test
    fun clientRejectsConnectionToTls11OnlyServer() = runTest {
    ...
    @Test
    fun clientConnectsToTls12Server() = runTest {
    ...
    @Test
    fun insecureClientAcceptsConnectionToTls11OnlyServer() = runTest {
        server.useHttps(tls11OnlySocketFactory(), false)
    ...
    private fun tls11OnlySocketFactory(): SSLSocketFactory {
        ...
        return object : SSLSocketFactory() {
            ...
            private fun SSLSocket.restrictToTls11() = apply {
                enabledProtocols = arrayOf("TLSv1.1")
            }
        }
    }
}
